...
exports.getAppUpdateInfo = function(successOrUrl, errorOrOptions, updateUrl) {
    // If the update URL hasnt been set in the updateUrl then assume no callbacks passed
    var successCallback = updateUrl ? successOrUrl : null;
    var errorCallback = updateUrl ? errorOrOptions : null;
    ...
    exec(successCallback, errorCallback, "AppUpdate", "getAppUpdateInfo",  [updateUrl, {}]);
};

exports.downloadAppUpdate = function(successOrUrl, errorOrOptions, updateUrl) {
    // If the update URL hasnt been set in the updateUrl then assume no callbacks passed
    var successCallback = updateUrl ? successOrUrl : null;
    var errorCallback = updateUrl ? errorOrOptions : null;
    ...
    exec(successCallback, errorCallback, "AppUpdate", "downloadAppUpdate",  [updateUrl, {}]);
};
