...
public class DownloadHandler extends Handler {
    ...
    public DownloadHandler(Context mContext, ProgressBar mProgress, AlertDialog mDownloadDialog, 
              String mSavePath, HashMap<String, String> mHashMap, Handler mHandler) {
    ...
    public void handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case Constants.DOWNLOAD_FINISH:
                ...
                // 安装文件
                installApk();
                // Byron added, 2020/03/04 ---------------------------------- 
                mHandler.sendEmptyMessage(Constants.DOWNLOAD_INSTALL_FINISH);
                // ---------------------------------------------------------- 
                break;
            default:
                break;
