...
public interface Constants {
    ...
    // Byron, 2020/02/26 ---------------
    int DOWNLOAD_INSTALL_FINISH = 6;
    int DOWNLOAD_START = 200; // download start
    int DOWNLOAD_END = 201; // thread/common end/completed
    // ---------------------------------

    // Byron, 2020/02/26 ---------------
    int VERSION_THREAD_START = 200; // thread/common start
    int VERSION_THREAD_END = 201; // thread/common end/completed
    // ---------------------------------
