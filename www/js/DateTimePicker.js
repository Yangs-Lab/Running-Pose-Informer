	...
	DateTimePicker.prototype = {
		...
		_showPicker: function(oElement)
		{
          ...
          $(oDTP.element).css({position: "absolute", top: iElemTop, left: iElemLeft, width: iElemWidth, height: "auto"});
				...
				oDTP._modifyPicker();
        // after fadeIn, set dtBox1 real RECT 
          ...
          }, 60); //oDTP.settings.animationDuration);	// modify by Byron
				}
			}
		},
		...
		// Public Method, setIsPopup --
		setIsPopup: function(bIsPopup) {
			var oDTP = this;
			if (oDTP.settings.isInline) return;
      //
      oDTP.settings.isPopup = bIsPopup;
      if ($(oDTP.element).css("display") !== "none") oDTP._hidePicker(0);
